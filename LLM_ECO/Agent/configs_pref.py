...
DESIGN_CONFIG_OVERRIDES = {
    "NV_NVDLA_partition_m": {
        "base_path": "data/NV_NVDLA_partition_m",
        "max_iterations_per_trace": 10,
        "objectives": DEFAULT_OBJECTIVES,
    },
    "NV_NVDLA_partition_p": {
        "base_path": "data/NV_NVDLA_partition_p",
        "max_iterations_per_trace": 10,
        "objectives": DEFAULT_OBJECTIVES,
    },
    "ariane136": {
        ...
        "max_iterations_per_trace": 10,
        "objectives": "Optimize timing but allow WNS of -35 ps, ignore TNS, while minimizing power and area.",
    },
    "mempool_tile_wrap": {
        "base_path": "data/mempool_tile_wrap",
        "max_iterations_per_trace": 10,
        "objectives": "Optimize timing but allow WNS of -130 ps, ignore TNS, while minimizing power and area.",
    },
    "aes_256": {
        "base_path": "data/aes_256",
        "max_iterations_per_trace": 10,
        "objectives": "Optimize timing but allow WNS of -27.5 ps, ignore TNS, while minimizing power and area.",
    },
    "hidden1": {
        "base_path": "data/hidden1",
        "max_iterations_per_trace": 10,
        "objectives": "Optimize timing but allow WNS of -30 ps, ignore TNS, while minimizing power and area.",
    },
    "hidden2": {
        "base_path": "data/hidden2",
        "max_iterations_per_trace": 10,
    ...
    "hidden5": {
        ...
        "max_iterations_per_trace": 10,
        "objectives": "Optimize timing but allow WNS of -15 ps, ignore TNS, while minimizing power and area.",
    },
    "NV_NVDLA_partition_m_test": {
        "base_path": "data/NV_NVDLA_partition_m_test",
...
TARGET_STRATEGY_DOC_PATH = "data/LLM_ECO/docs/opt_target_strategies.txt"
COMMAND_STRATEGY_DOC_PATH = "data/LLM_ECO/docs/opt_command_strategies.txt"
