...
from configs import PT_SERVER_CONFIG, base_path, get_agent_dir, get_agent_logs_dir
...
class AgentRunPaths:
    ...
    def __init__(self, round_index, run_root=None, server_port=None):
        ...
        self.workspace = os.path.abspath(base_path)
        self.run_root = os.path.abspath(run_root or get_agent_dir())
        self.run_dir = os.path.join(self.run_root, f"round_{round_index}")
        self.scripts_dir = self.run_dir
        self.logs_dir = os.path.abspath(get_agent_logs_dir())
