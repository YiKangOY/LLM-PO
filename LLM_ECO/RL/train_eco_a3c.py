#!/usr/bin/env python3
"""
Entry point to train/test the ECO A3C implementation that mirrors the
reference `dse` framework. This replaces the prior Stable-Baselines3 driver.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Train/Test ECO A3C agent")
    parser.add_argument(
        "--mode",
    ...
    parser.add_argument("--algo", choices=["a3c", "ppo"], default="a3c")
    parser.add_argument(
